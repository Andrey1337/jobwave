...
<header class="header">
        ...
        <div class="container-fluid container_main">
            <div class="logo_block">
                <img src="{{ asset('img/logo/logo.svg')}}" class="logo_img_header img-fluid" alt="logo">
            ...
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item auths_btns m-auto">
                <a class="nav-link mulish16r" href="{{route('applicant.login')}}">Вход</a>
                </li>
                <li class="nav-item">
                <a class="nav-link mulish16r" href="{{route('applicant.register')}}">Регистрация</a>
                </li>
            </ul>
            </div>
        </div>
